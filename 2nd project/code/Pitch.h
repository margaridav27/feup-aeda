...
public:
    ...
    /**
     * Adds a service provider type to the queue and its correspondent pointer to the vector of employees
     * @param spt service provider type to be added to the queue
     */
    void addServiceProvider(ServiceProviderType spt);

    /**
     * Adds a contracted employee type to the queue and its correspondent pointer to the vector of employees
     * @param cet contracted employee type to be added to the queue
     */
    void addContractedEmployee(ContractedEmployeeType cet);
