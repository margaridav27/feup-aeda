...
public:
    /**
     * Initializes a service provider type through a pointer to the service provider
     * @param sp
     */
    ServiceProviderType(ServiceProvider *sp);

    /**
     * @return pointer to the service provider
     */
...
public:
    /**
     * Initializes a contracted employee type through a pointer to the contracted employee
     * @param ce
     */
    ContractedEmployeeType(ContractedEmployee *ce);

    /**
     * @return pointer to the contracted employee
     */
